...
namespace database
{
    ...
    std::optional<long> User::auth(const std::string &login, const std::string &password)
    {
        try
        {
            Poco::Data::Session session = database::Database::get().create_session();
    ...
    std::vector<User> User::search(const std::string &first_name, const std::string &last_name)
    {
        try
        {
            Poco::Data::Session session = database::Database::get().create_session();
